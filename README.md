...
Aprendo melhor mexendo. Leio o suficiente pra entender o problema, e depois resolvo com código de verdade. Boa parte do que sei veio dessa rotina.
...
####  [Antifraude-AI-Bot](https://github.com/Ferrazzz05/Antifraude-AI-Bot)
...
I'm a Full Stack developer who spends most of the time on Python backend, but I also handle the web side (HTML, CSS and JavaScript) when a project needs a real interface.

What interests me most right now is connecting systems that don't normally talk to each other: external APIs, databases, AI tools, browser automation. I like building things that run on their own and deliver value without constant babysitting.

I learn best by doing. I read enough to understand the problem, then I solve it with real code. Most of what I know came from that loop.
